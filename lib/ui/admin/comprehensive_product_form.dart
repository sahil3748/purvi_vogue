...
class ComprehensiveProductForm extends StatefulWidget {
  final ProductModel? product;
  
  const ComprehensiveProductForm({super.key, this.product});

  @override
  State<ComprehensiveProductForm> createState() => _ComprehensiveProductFormState();
}

class _ComprehensiveProductFormState extends State<ComprehensiveProductForm> {
